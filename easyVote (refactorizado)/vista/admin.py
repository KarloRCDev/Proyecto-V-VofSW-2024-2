...
class Admin:
    def __init__(self):
        ...
        self.etiqueta = tk.Label(
            self.ventana, text="ESTADISTICAS DE LAS ELECCIONES")
        ...
        self.boton1 = tk.Button(self.contenedor, text="Estadística\nGeneral\nQUICKSORT",
                                width=20, height=10, command=self.boton1_click)
        self.boton2 = tk.Button(self.contenedor, text="Estadística por\nDepartamento\nHEAPSORT",
                                width=20, height=10, command=self.boton2_click)
        self.boton3 = tk.Button(self.contenedor, text="Estadística por\nGénero\nBURBUJA",
                                width=20, height=10, command=self.boton3_click)
        self.boton4 = tk.Button(self.contenedor, text="Estadística por\nEdad\nMERGESORT",
                                width=20, height=10, command=self.boton4_click)
        self.boton_salir = tk.Button(
            self.contenedor, text="Salir", width=20, height=10, command=self.boton_salir_click)
